            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="hero-text">
                        ...
                        <h1 class="display-4"><span><img src="{{ asset('storage/bintang.jpg') }}" alt="Image" class="star-img"></span>Red Velvet Latte<span><img src="{{ asset('storage/bintang.jpg') }}" alt="Image" class="star-img"></span></h1>
